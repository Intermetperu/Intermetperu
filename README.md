...
<table width="100%">
  <tr>
    <td width="33%" align="center" valign="top">
      ...
      <p>Congresos y programas de actualización especializados para profesionales de minería, metalurgia e ingeniería.</p>
    </td>
    <td width="33%" align="center" valign="top">
      <h3>🏗️ Eventos Especializados</h3>
      <p>Organización integral de congresos internacionales: gestión de ponentes, publicaciones, stands y auspicios.</p>
    </td>
    <td width="33%" align="center" valign="top">
      <h3>🤖 Software & IA Minera</h3>
      <p>Desarrollo propio de plataformas para gestión de participantes, acreditación QR, automatización y bases de datos.</p>
    </td>
  </tr>
</table>
